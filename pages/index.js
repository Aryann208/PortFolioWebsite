      ...
      <main className="bg-white px-10">
        <section className=" min-h-screen">
          ...
          <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600">
            <a href="https://www.linkedin.com/in/aryan-trivedi-14279a190">
              <AiFillLinkedin />
            </a>
              ...
              <div className="w-11/12 mx-auto">
                ...
                <p className="text-white  font-serif py-3  ">
                  <div className="flex">
                    ...
                    <a href="https://aryann208.github.io/Expanding-Cards/">
                      https://aryann208.github.io/Expanding-Cards/
                    </a>
                  </div>
                  <div className="flex">
                    <h2 className="text-1xl uppercase font-bold font-sans mr-3 justify-center align-bottom">
                    ...
                    <a href="https://github.com/Aryann208/Expanding-Cards.git">
                      https://github.com/Aryann208/Expanding-Cards.git
                    </a>
                  </div>
                </p>
              </div>
              ...
              <div className="w-11/12 mx-auto">
                ...
                <p className="text-white  font-serif py-3  ">
                  <div className="flex">
                    ...
                    <a href="https://aryann208.github.io/Progress-Steps/">
                      https://aryann208.github.io/Progress-Steps/
                    </a>
                  </div>
                  <div className="flex">
                    <h2 className="text-1xl uppercase font-bold font-sans mr-3 justify-center align-bottom">
                    ...
                    <a href="https://github.com/Aryann208/Progress-Steps">
                      https://github.com/Aryann208/Progress-Steps
                    </a>
                  </div>
                </p>
              </div>
              ...
              <div className="w-11/12 mx-auto">
                ...
                <p className="text-white  font-serif py-3  ">
                  ...
                  <div className="flex">
                    ...
                    <a href="https://github.com/Aryann208/Rotating-Navbar">
                      https://github.com/Aryann208/Rotating-Navbar
                    </a>
                  </div>
                </p>
              </div>
          ...
          <div className="flex flex-col justify-center p-5 ">
            <div className="flex align-center py-3 ">
              ...
              <span className="text-white">
                <a className="text-white" href="https://github.com/Aryann208">
                  Github Profile
                </a>
              </span>
            </div>
